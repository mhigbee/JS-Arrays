...
function finder (arrayNumbers) {
    var randomNumber = getRandomArbitrary();
    for (var i = 0; i < arrayNumbers.length; i++) {
        if (randomNumber === arrayNumbers[i]) {
            return true;
        }
    }
    return false;
...
function removeItem (myGroceryList,removeItemFromList){
    if(!myGroceryList) {
        return [];
    }
    for (var i = 0 ;i < myGroceryList.length; i++) {
        if (myGroceryList[i] === removeItemFromList) {
...
function addItem (myGroceryList,addItem){
    ...
    var updatedGroceryList = myGroceryList;
    updatedGroceryList.push(addItem);
...
function addTen (numbers) {
    ...
    for (var i = 0; i < numbers.length; i++) {
        arrayPlusTen.push(parseInt(numbers[i]) + 10);
    }
    return arrayPlusTen;
};
